...
export const GoogleMeetEmailAr = ({ name }: { name: string }) => {
  return (
    <Html dir="rtl" lang="ar">
      <Head />
      <Preview>رابط الجلسة التدريبية</Preview>
          ...
          >
            ...
            <tr>
              <td colSpan={2}>
                ...
                >
                  نحن متحمسون لانضمامك إلينا في الجلسة التدريبية المجانية!
                  <br />
                  <br />
                  <strong>رابط Google Meet:</strong>{' '}
                  <a
                    href="https://meet.google.com/nvj-zkiz-yuj"
                    style={{ color: '#4EA8F8', direction: 'ltr' }}
                  >
                    https://meet.google.com/nvj-zkiz-yuj
                  </a>
                  <br />
                  <br />
                  يرجى الانضمام قبل الموعد ببضع دقائق لضمان بدء الجلسة بسلاسة.
                  <br />
