...
export const ThankYouEmailFr = ({ name }: { name: string }) => {
  return (
    <Html>
      <Head />
      <Preview>Merci pour votre inscription !</Preview>
            ...
            <tr>
              <td colSpan={2}>
                ...
                >
                  ...
                  <br />
                  Merci de vous être inscrit à notre session de formation gratuite. Nous sommes ravis de vous compter parmi nous !
                  <br />
                  Vous recevrez un e-mail contenant le lien Google Meet avant la date de la session.
                  <br />
